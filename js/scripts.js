...
(function() {
  ...
  Bivouac.App = (function() {
    ...
    function App() {
      this.onControllerButtonClick = __bind(this.onControllerButtonClick, this);
      this.keys = ['X', 'A', 'B', 'Y'];
      this.keysIndex = 0;
      this.addHint();
    ...
    App.prototype.addHint = function() {
      var i, key, li, random, _i, _j, _len, _ref;
      this.pattern = [];
    ...
    App.prototype.onControllerButtonClick = function(e) {
      ...
      if (value === this.pattern[this.keysIndex]) {
        ...
        this.keysIndex++;
        if (this.keysIndex === this.pattern.length) {
          return new Bivouac.Invaders;
        }
      } else {
  ...
  Bivouac.Invaders = (function() {
    ...
    Invaders.prototype.render = function() {
      this.moveShip();
      this.moveBullets();
      if (this.isShooting && this.bullets.length < 1) {
        return this.shootBullet();
      }
    };

    Invaders.prototype.moveShip = function() {
      if (this.isGoing.left && !this.isGoing.right) {
        this.speed -= 2;
      }
      if (this.isGoing.right && !this.isGoing.left) {
        this.speed += 2;
      }
      if (this.speed > 50) {
        this.speed = 50;
